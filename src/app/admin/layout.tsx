...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // ACCESO PÚBLICO TOTAL: Se eliminan las validaciones de seguridad para facilitar el despliegue.

  return (
    <div className="min-h-screen bg-[#00001D] flex text-white font-body">
      {/* Sidebar */}
      <aside className={cn(
        "fixed md:relative z-50 h-full bg-black/40 border-r border-white/10 backdrop-blur-xl transition-all duration-300",
