...
import { Home, Zap, Plus, Briefcase, Mail, X, Smartphone, Bot, GraduationCap, Globe, ArrowRight } from 'lucide-react';
            ...
            {activePopup === 'mega' && (
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    { title: "Candy AI", icon: Bot, desc: "Asistente Inteligente", color: "from-blue-500 to-cyan-500" },
                    { title: "Neocard", icon: Smartphone, desc: "Simulador Digital", color: "from-primary to-secondary" },
                    { title: "Academy", icon: GraduationCap, desc: "Recursos & Tips", color: "from-yellow-500 to-orange-500" },
                    { title: "Global", icon: Globe, desc: "Status de Red", color: "from-emerald-500 to-teal-500" }
                  ].map((m, i) => (
                    <button key={i} className="group p-6 rounded-3xl bg-white/[0.03] border border-white/5 hover:border-white/20 transition-all text-center flex flex-col items-center gap-4">
