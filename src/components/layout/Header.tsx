    ...
    <>
      ...
      >
        ...
        <div className="max-w-screen-2xl mx-auto h-full px-8 relative flex items-center justify-between">
          ...
          {/* Logo Centrado en la Muesca */}
          <Link href="/" className="absolute left-1/2 top-[35%] -translate-x-1/2 -translate-y-1/2 z-[140] flex flex-col items-center">
            <div className="relative h-8 w-28 md:h-10 md:w-36 transition-transform hover:scale-105">
              <Image 
                src={LOGO_URL} 
                alt="Naxde Logo" 
                fill
          ...
          <button 
            ...
            className="relative z-[150] w-12 h-12 flex flex-col items-center justify-center gap-1.5 focus:outline-none group pointer-events-auto mt-[-10px] md:mt-[-20px]"
          >
            <div className={cn(
