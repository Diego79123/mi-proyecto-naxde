...
export const FeaturedServices = () => {
  ...
  return (
    ...
    >
      {/* Decorative Figure - Rotación constante y sutil */}
      <div 
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[150vw] h-[150vw] border-[1px] border-[#5200F8]/5 rounded-full pointer-events-none will-change-transform flex items-center justify-center"
        style={{ 
          transform: `translate(-50%, -50%) rotate(${scrollProgress * 360}deg)`,
        }}
      >
        <div className="w-[85%] h-[85%] border-[30px] md:border-[80px] border-[#5200F8]/5 rounded-full" />
      </div>
        ...
        <div className="flex flex-col gap-12 mb-24 md:mb-32">
          <div className="space-y-6">
            ...
            <h2 className="text-[12vw] md:text-[9vw] font-black leading-[0.85] tracking-tighter uppercase select-none">
              <div>MÁS ALLÁ</div>
              <div className="text-transparent" style={{ WebkitTextStroke: '1.5px black' }}>DE LAS VISIONES</div>
              <div>AL ALCANCE</div>
            </h2>
          </div>
